<nav class="navbar navbar-expand-xl navbar-light">
    ...
    <div class="collapse navbar-collapse px-2"  id="navbarSupportedContent">
        ...
        ?>
            <div class="d-flex header-service">
                <button onclick="location.href='main.php';"  type="button" class="d-flex btn btn-light fs-6 mx-1 header-button" data-bs-toggle="button" autocomplete="off">
                    <div class="mx-auto" style="">
                        บริการ
                    </div>
                </button>
                <button onclick="location.href='hair_dressor.php';"  type="button" class="d-flex btn btn-light fs-6 mx-1 header-button" data-bs-toggle="button" autocomplete="off">
                    <div class="mx-auto" style="">
                        ช่าง
                    </div>
                </button>
                <button onclick="location.href='account.php';"  type="button" class="d-flex btn btn-light fs-6 mx-1 header-button" data-bs-toggle="button" autocomplete="off">
                    <div class="mx-auto" style="">
                        โปรไฟล์
                    </div>
                </button>
