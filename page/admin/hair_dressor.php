            ...
            <div class="col-sm-12 col-md-4 col-lg-3 my-2">
                <div class="d-flex flex-column service__content-container bg-white p-3">
                    ...
                    <div class="mx-auto my-2">
                        <button onclick=<?php echo 'location.href="hair_booking.php?hair_dressor_id=' . $v['hair_dressor_id'] . '&hair_dressor_name=' . $v['hair_dressor_name'] . '"'; ?>  class="m-auto service__button" style="background-color: transparent;">ยืนยัน</button>
                    </div>
                </div>
            </div>
            <?php
